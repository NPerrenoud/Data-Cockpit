...
public class CustomKeyedValues2D implements KeyedValues2D,
...
Serializable {
	...
	public int getRowIndex(Comparable key) {
		...
		if (this.sortRowKeys) {
			List toSearch = this.rowKeys;
			return Collections.binarySearch(toSearch, key);
		}
		else {
