...
public class ParetoProvider extends XYChartProvider {
	 ...
	 * (non-Javadoc)
	 * @see ch.epfl.datacockpit.visualizer.gui.XYChartProvider#buildOneMethod(ch.epfl.datacockpit.visualizer.charts.ChartContainer, ch.epfl.general_libraries.results.DataRetrievalOptions, java.awt.BasicStroke, int, ch.epfl.general_libraries.results.AdvancedDataRetriever)
	 */
