...
import ch.epfl.datacockpit.tree.clazzes.ConstructorDef;


public class ClassChooseNode extends AbstractParameterChooseNode implements Serializable {
	
	private transient final static ch.epfl.general_libraries.logging.Logger logger = new ch.epfl.general_libraries.logging.Logger(ClassChooseNode.class);
