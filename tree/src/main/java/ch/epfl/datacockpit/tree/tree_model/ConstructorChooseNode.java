...
import ch.epfl.datacockpit.tree.clazzes.ClassUtils;
import ch.epfl.datacockpit.tree.clazzes.ObjectRecipe;
...
public class ConstructorChooseNode extends AbstractChooseNode {
	...
	private transient final static ch.epfl.general_libraries.logging.Logger logger = new ch.epfl.general_libraries.logging.Logger(ConstructorChooseNode.class);	
